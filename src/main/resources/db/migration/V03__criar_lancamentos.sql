...
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo_lancamento, categoria_id, pessoa_id) values ('Salário mensal', '2017-06-10', null, 6500.00, 'Distribuição de lucros', 'RECEITA', 1, 4);
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo_lancamento, categoria_id, pessoa_id) values ('Supermercado', '2017-02-10', '2017-02-10', 100.32, null, 'DESPESA', 2, 5);
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo_lancamento, categoria_id, pessoa_id) values ('Academia', '2017-06-10', null, 120, null, 'DESPESA', 3, 6);
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo_lancamento, categoria_id, pessoa_id) values ('Conta de luz', '2017-02-10', '2017-02-10', 110.44, null, 'DESPESA', 4, 7);
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo_lancamento, categoria_id, pessoa_id) values ('Publicidade', '2017-06-10', null, 200.30, null, 'RECEITA', 3, 8);
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo_lancamento, categoria_id, pessoa_id) values ('Restaurante', '2017-03-10', '2017-03-10', 1010.32, null, 'DESPESA', 4, 9);
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo_lancamento, categoria_id, pessoa_id) values ('Venda vídeo game', '2017-06-10', null, 500, null, 'RECEITA', 5, 10);
